...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-800 text-white py-3 lg:py-4 mt-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-4 mb-2 md:mb-0">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-amber-300 hover:text-amber-200 transition-colors cursor-pointer text-sm font-medium"
              title="Support"
            >
              ☕ Support
            </a>
          ...
          <div>
            <span className="text-xs text-gray-400">Free &amp; open source</span>
          </div>
        </div>
